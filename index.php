...
<head>  
    ...
    <meta name = "description" content = "Jian's kitchen is a premium food delivery service privider with the mission to bring affordable and healthy meals to as many people as possible.">
...
<body>
    <header>
        <nav>
            <div class = "row">
                ...
                <a class = "mobile-nav-icon js--nav-icon"><ion-icon name="menu-outline" class = "mobile-nav-icon-style"></ion-icon></a>
            </div>
        </nav>
    ...
    <section class = "section-features js--section-features" id = "features">
        ...
        <div class = "row js--wp-1">
            <div class = "col span-1-of-4 box">
                <ion-icon  name="repeat-outline" class ="big-icon" ></ion-icon>
            ...
            <div class = "col span-1-of-4 box">
                <ion-icon name="timer-outline" class ="big-icon"></ion-icon>
    ...
    <section class = "section-meals">
        ...
        <ul class = "meals-showcase clearfix">
            ...
            <li> <figure class = "meal-photo"><img src = "resources/img/3.jpg" alt ="Chicken breast steak with vegetable "> </figure></li>
            ...
            <div class = "col span-1-of-4 box">
                ...
                <h3>Lisbon</h3>
                    <div class = "city-feature">
                        <ion-icon name="people-outline" class = "icon-small"></ion-icon>
                        1600+ happy eaters
                    </div>
                    <div class = "city-feature">
    ...
    <section class = "section-testinomials">
        <div class = "row">
                ...
                <div class = "plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li ><ion-icon name="close-outline icon-small" class = "icon-small" ></ion-icon></li>
                            <li ><ion-icon name="checkmark-outline" class =  "icon-small"></ion-icon>Free delivery</li>
                        </ul>
                    </div>
                    <div>
        ...
        <div class = "row">
            <form method = "post" action = "mailer.php" class = "contact-form">
                ...
                <div class = "row">
                    ...
                    <div class = "col span-2-of-3">
                        <input type = "checkbox" id = "news" checked> Yes, Please
                    </div>
                </div>
        ...
        <div  class = "row">
            ...
            <div class = "col span-1-of-2">
                <ul class = "social-links">
                    <li><a href = "#"><ion-icon name="logo-facebook" class = "facebook-logo"></ion-icon></a></li>
                    <li><a href = "#"><ion-icon name="logo-twitter" class = "twitter-logo"></ion-icon></a></li>
                    <li><a href = "#"><ion-icon name="logo-google" class = "google-logo"></ion-icon></a></li>
                    <li><a href = "#"><ion-icon name="logo-instagram" class = "instagram-logo"></ion-icon></a></li>
                </ul>
            </div>
        </div>
        <div  class = "row">
